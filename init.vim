" Sets {{{
set exrc "Enables the reading of .vimrc, .exrc and .gvimrc in the current
...
set hidden " When off a buffer is unloaded when it is |abandon|ed.
...
set nowrap " This option changes how text is displayed.  It doesn't change the text in the buffer, see 'textwidth' for that.
set formatoptions-=t " This is a sequence of letters which describes how automatic formatting is to be done. 
